# -*- coding: utf-8 -*-
"""I/O helpers for P/V850 latitudinal object-change audit v1_a."""
...
def ensure_output_dirs(settings: PVLatitudinalObjectChangeSettings) -> Dict[str, Path]:
    dirs = {
...
def load_smoothed_fields(settings: PVLatitudinalObjectChangeSettings) -> Tuple[Dict[str, np.ndarray], Path]:
