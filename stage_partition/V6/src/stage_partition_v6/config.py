...
class ContractConfig:
    candidate_scope: str = "all_baseline_detected_local_peaks"
    headline_metric_mode: str = "bootstrap_local_peak_recurrence"
    year_support_mode: str = "auxiliary_only"
    include_window_judgement: bool = False
...
@dataclass
class OutputConfig:
    output_tag: str = "mainline_v6_a"
    write_plots: bool = False


@dataclass
class StagePartitionV6Settings:
