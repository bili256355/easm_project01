...
def match_candidates_to_local_peaks(registry_df: pd.DataFrame, local_peaks_df: pd.DataFrame, cfg, *, replicate_id: int, replicate_kind: str, replicate_label: str | int | None = None) -> pd.DataFrame:
    cols = [
        'replicate_id','replicate_kind','replicate_label','candidate_id','point_day','month_day',
