...
### W045
- H-Je: B_layer_specific_front_or_lead_candidate (Level4_window_or_curve_supported)
...
- Jw-V: co_transition (Level3_window_overlap)
...
- raw/profile object-window detector uses detector_search_range and original V7-z z-scored climatological profile input.
