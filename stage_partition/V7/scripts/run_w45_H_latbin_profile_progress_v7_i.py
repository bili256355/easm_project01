...
from stage_partition_v7.w45_H_latbin_profile_progress import run_w45_H_latbin_profile_progress_v7_i


if __name__ == "__main__":
    run_w45_H_latbin_profile_progress_v7_i(v7_root=V7_ROOT)
