...
REQUIRED_SMOOTHED_KEYS = [
    'precip_smoothed', 'u200_smoothed', 'z500_smoothed', 'v850_smoothed', 'lat', 'lon', 'years'
]


def prepare_output_dirs(settings: StagePartitionV2Settings) -> dict[str, Path]:
...
def resolve_smoothed_fields_path(settings: StagePartitionV2Settings) -> Path:
